...
$wgLogo = "$wgResourceBasePath/resources/assets/wikiclaim.png";
...
$wgEmergencyContact = getenv('wgEmergencyContact');
$wgPasswordSender = getenv('wgPasswordSender');
...
$wgDBmwschema = getenv('wgDBmwschema');
